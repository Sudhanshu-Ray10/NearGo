        ...
        <>
            ...
            <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-6">
                 ...
                 >
                     ...
                     <span className="text-sm">{locationOpen ? "Close" : "Change"}</span>
                 </button>

                 {/* Mobile Location Selector UI */}
                 {locationOpen && (
                    <div className="flex flex-col gap-3 p-3 bg-white border border-gray-100 rounded-xl shadow-sm animate-in fade-in zoom-in-95 duration-200 dark:bg-slate-900 dark:border-gray-800 -mt-4">
                        {/* Search Input */}
                        <div className="relative">
                            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={16} />
                            <input
                            ...
                            {isSearchingPincode ? (
                                ...
                                <ul className="flex flex-col gap-1">
                                    {filteredLocations.length > 0 ? (
                                        ...
                                        <li className="text-center py-4 text-gray-500 text-sm">No locations found</li>
                                    )}
                                </ul>
                            )}
                        </div>
