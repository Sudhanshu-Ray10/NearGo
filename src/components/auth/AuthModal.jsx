...
import { X, Phone, ArrowRight, CheckCircle2, Loader2, Quote, LogIn, Code, Home } from 'lucide-react';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[92vw] md:max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-0 md:min-h-[500px] max-h-[92vh] md:max-h-[90vh]"
          >
            ...
            {/* RIGHT SIDE - Form */}
            <div className="w-full md:w-7/12 bg-white p-6 md:p-12 flex flex-col justify-center overflow-y-auto">
                        ...
                        {step === 'PHONE' && (
                            <>
                                ...
                                <button 
                                    ...
                                    className="md:hidden flex items-center justify-center gap-2 w-full py-4 text-gray-500 hover:text-gray-800 transition-colors font-medium border-t border-gray-100 mt-6"
                                >
                                    <Home size={18} />
